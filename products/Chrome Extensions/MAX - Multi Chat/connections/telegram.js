// connections/telegram.js
// Bypass Telegram Web iframe detection using Main World script injection.
(function() {
  ...
  console.log("MAX Multi Chat: Telegram iframe bypass activated (top/parent/self/frameElement overridden).");
})();
